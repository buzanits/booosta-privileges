# Abstract user privileges for Booosta PHP Framework

This modules provides abstract administration of user privileges for PHP Booosta. For real administration
of privileges this class must be extended for use of a storage engine for the privileges.
